                        ...
                        <div class="card-header">
                            <div class="card-title">
                                ...
                                <div class="btn-group">
                                    ...
                                    <span class="text-muted text-sm d-none d-sm-block">
                                        @lang('messages.backups.yandex.breadcrumbs.buckets.create')
                                    </span>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="d-block d-xl-none">
                        <h3>@lang('messages.backups.yandex.breadcrumbs.buckets.create')</h3>
                    </div>
                </div>
            </div>
