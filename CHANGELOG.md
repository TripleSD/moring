[v.0.1.13 (Build.013)](https://github.com/TripleSD/moring/releases/tag/build.013)
- **(New)** - Добавлен сбор ошибок сетевых устройств
- **(New)** - Добавлено Telegram уведомление о проверке работоспособности системы
- **(New)** - Добавлено именований версий в human style (v.0.1.13)
- **(Upd)** - Сделана поддержка перемещения виджетов на главной странице 
- **(Upd)** - Опрос устройств по SNMP установлен на более короткий интервал (1мин)
- **(Upd)** - По-умолчанию в env файле отключен вывод debug информации
- **(Upd)** - В списке сетевых устройств добавлен вывод счетчика необработанных ошибок
- **(Upd)** - В списке сетевых устройств добавлен вывод статуса устройства
- **(Upd)** - В списке сетевых устройств добавлен вывод статуса ssh подключения
- **(Upd)** - В списке сетевых устройств добавлен вывод статуса telnet подключения
- **(Upd)** - В списке сетевых устройств добавлен вывод статуса web подключения
- **(Fix)** - Исправлен вывод ошибок о deprecated и старых версия PHP интерпретаторов
