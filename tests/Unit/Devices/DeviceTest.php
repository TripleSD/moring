...
class DeviceTest extends TestCase
{
    public function testStoreDevice(): void
    {
        ...
        $this->assertDatabaseHas('devices', ['snmp_port' => 161]);
        $this->assertDatabaseHas('devices', ['snmp_community' => 'public']);
        $this->assertDatabaseHas('devices', ['snmp_version' => 2]);
    ...
    public function testUpdateDevice(): void
    {
        ...
        $this->assertDatabaseHas('devices', ['snmp_port' => 162]);
        $this->assertDatabaseHas('devices', ['snmp_community' => 'private']);
        $this->assertDatabaseHas('devices', ['snmp_version' => 3]);
    ...
    private function getDeviceData(): array
    {
        ...
        $deviceData['snmp_port']       = 161;
        $deviceData['snmp_community']  = 'public';
        $deviceData['snmp_version']    = 2;
    ...
    private function getDeviceDataForUpdate(): array
    {
        ...
        $deviceData['snmp_port']       = 162;
        $deviceData['snmp_community']  = 'private';
        $deviceData['snmp_version']    = 3;
