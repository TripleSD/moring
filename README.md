...
* Добавлена тема основного оформления системы
* Осуществлена настройка авторизации пользователей в системе без разделения прав
* Добавлено автоматическое получение сведений о бридже
* Добавлено автоматическое получение сведений о версиях системы
...
* Добавлен быстрый опрос состояний всех сайтов
